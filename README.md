...
- [`SPEC.md`](./spec/v0.1.md)  the full v0.1 language specification
- [`5-minutes.md`](./5-minutes.md) a fast-read introduction with worked examples
- [`grammar/`](./grammar/)  the ANTLR4 grammar
- [`examples/`](./examples/)  reference xDBML documents covering e-commerce, healthcare, IoT, financial services, event-driven systems, and graph models
...
- [xdbml.org](https://xdbml.org)  canonical home, playground (TBA), and community (TBA)
