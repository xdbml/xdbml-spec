...
var { compressToEncodedURIComponent } = require_lz_string();
var PLAYGROUND_BASE = "https://xdbml.org/playground/";
...
function activate(context) {
  const command = vscode.commands.registerCommand("xdbml.openInPlayground", async () => {
    ...
    const source = selection && !selection.isEmpty ? editor.document.getText(selection) : editor.document.getText();
    if (!source.trim()) {
