...
xDBML also interoperates with contemporary standards that postdate its design rather than informing it, notably Google's [Open Knowledge Format (OKF)](https://cloud.google.com/blog/products/data-analytics/how-the-open-knowledge-format-can-improve-data-sharing) for agent-facing knowledge context. See [§29](#_29-relationship-to-other-standards) for how an xDBML schema relates to it.
