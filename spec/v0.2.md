...
description: The complete xDBML v0.2 specification. Thirty chapters plus five appendices covering lexical conventions, entities, relationships, polymorphism, views, AI-readiness metadata, validation constraints, entity-level checks, the module system, AST representation, conformance, and DBML 3.13.6 compatibility.
---
