---
title: Specification
description: The xDBML specification. v0.2 is the current draft. Apache License 2.0. Backward-compatible additions are MINOR versions; documents declaring a specific version are stable across MINOR and PATCH releases.
---
...
|---------|--------|----------|-------|
| [v0.2](./v0.2) | Draft -- current | 2026 | Adds the module system (`use`/`reuse` directives with optional clone blocks), scalar Named Types, and field-level imports. Strict superset of v0.1. |
...
If you are writing new xDBML documents, use the latest draft (currently v0.2). If you are reading documents authored elsewhere, the document's first line declares which version's semantics apply.
...
- [`v0.2.md`](https://github.com/xdbml/xdbml-spec/blob/main/spec/v0.2.md) -- current draft
