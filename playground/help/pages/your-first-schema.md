...
- [**The interface**](./layout-overview.html) for more detail on each pane.
- [**Reading the diagram**](./reading-the-diagram.html) to understand the visual vocabulary in depth (crow's foot variants, nested fields, container styling).
- [**Loading examples**](./loading-examples.html) to try the bundled sample schemas as starting points for your own work.
