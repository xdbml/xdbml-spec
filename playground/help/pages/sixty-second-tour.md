...
[**Your first schema**](./your-first-schema.html) walks through writing a small schema from scratch and exploring each of the features above hands-on.

If you want more depth on any specific pane, [**The interface**](./layout-overview.html) covers each pane individually.
