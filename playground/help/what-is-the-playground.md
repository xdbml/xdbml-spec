...
description: A free, browser-based tool for writing, visualizing, and sharing xDBML schemas.
---
...
See [**Persistence & undo**](./persistence-and-undo) for the full story on how local storage, URL hashes, and the editor's undo history interact.
